//
//  DDCQRCodeGenerateManager.swift
//  DDCOfflineStore
//
//  Created by sunlimin on 2018/11/19.
...
class DDCQRCodeGenerateManager: NSObject{
    
    //MARK: -传进去字符串,生成二维码图片
    class func setupQRCodeImage(_ url: String, image: UIImage?) -> UIImage {
        //创建滤镜
